...
export default function AboutMain() {
  return (
    <div className="">
      <div className="py-4 md:py-1 w-full text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-14 my-8 mb-4 md:my-8 md:p-0 md:max-w-5xl md:mx-auto ">
        {HomePageData.whyChooseUs.map((item) => (
          <div
            className="flex gap-6 items-center justify-center md:py-16 py-8 px-4 md:px-8 rounded-md bg-white shadow-xl"
            key={item.id}
          >
